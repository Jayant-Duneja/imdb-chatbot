...
class UserIntent(BaseModel):
    ...
    """
    name : str = Field(description="Name of the movie or the series that the user is talking about.")
    intent : str = Field(description="""The topic the user wants to talk about. Can be one of the following:
