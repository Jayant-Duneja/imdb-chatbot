...
# React to user input
if prompt := st.chat_input("I am a helpful Imdb bot. Ask me anything about movies or TV Shows!"):
    ...
    with st.chat_message("assistant"):
        st.markdown(f"Got it! You want to know about the {user_intent.name} and want to talk about the {user_intent.intent}.")
